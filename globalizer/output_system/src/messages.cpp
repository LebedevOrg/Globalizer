...
bool TOutputMessage::mIsMPIInit = false;
int TOutputMessage::mProcessCount = 1;
int TOutputMessage::mProcessNumber = 0;
...
// ------------------------------------------------------------------------------------------------
void TOutputMessage::Init(bool isMPIInit, std::string logFileName, int processCount,
